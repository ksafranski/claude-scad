...
/**
 * The mark. The same cube is the favicon, the installed-app icon and the wordmark
...
export function Logo({ size = 22, withWordmark = true }: { size?: number; withWordmark?: boolean }) {
  return (
    <span className="flex items-center gap-2.5">
      ...
      {withWordmark && <span className="font-display font-bold tracking-tight">Claude SCAD</span>}
    </span>
  );
}
