...
/**
 * What a composer would collect as it sends.
 *
 * Scaid's studio fills this with a snapshot for the design agent. There is no agent here, so
 * nothing ever asks for one — the type stays so the capture path compiles unchanged.
 */
